...
#define LOCALID_SANDGEM_POKECENTER1F_EXPERT 2
#define LOCALID_SANDGEM_POKECENTER1F_LASS 3

// SandgemTown_PokemonCenter_2F
#define LOCALID_SANDGEM_POKECENTER2F_TEALA1 1
#define LOCALID_SANDGEM_POKECENTER2F_TEALA2 2
#define LOCALID_SANDGEM_POKECENTER2F_LASS 3
...
#define LOCALID_SANDGEM_MART_SCHOOLKID 2
#define LOCALID_SANDGEM_MART_BREEDER 3
...
#define LOCALID_SCHOOL_KID_2 3
#define LOCALID_SCHOOL_KID_3 4
...
#define LOCALID_TVF1_BEAUTY 1
#define LOCALID_TVF1_GYMGUIDE 2
#define LOCALID_TVF1_PRESIDENT 3
#define LOCALID_TVF1_LOTTERY 4
#define LOCALID_TVF1_ACETRAINER 5
...
#define LOCALID_TVF2_ROUGHNECK 3

// JubilifeCity_JubilifeTV_F3 (GYM_GUIDE reusa sprite GYM_GUY, ja usado em F1/F2)
#define LOCALID_TVF3_BEAUTY1 1
#define LOCALID_TVF3_GYMGUIDE1 2
#define LOCALID_TVF3_BEAUTY2 3
#define LOCALID_TVF3_GYMGUIDE2 4
