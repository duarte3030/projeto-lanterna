...
# E a flag de esconder dele TEM de voltar: o ON_LOAD do mapa acende e apaga
# FLAG_HIDE_SILVER_GOLDENROD conforme a luta 3 e a 4 do rival, e sem a flag no
# objeto o Silver ficava em pé no salão o jogo inteiro (achado na retomada de
# 23/09/2026: o T237.12 esbarrou nele numa save que nunca o encontrou).
SWITCHES["objetos"][6]["flag"] = "FLAG_HIDE_SILVER_GOLDENROD"
