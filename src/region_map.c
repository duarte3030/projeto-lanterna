...
static const u8 sMapHealLocations[][3] =
{
    ...
    // Hoenn EX (lote A, 23/09/2026): Foothill Town, cidade nova do Emerald EX, com voo.
    [MAPSEC_FOOTHILL_TOWN] = {MAP_GROUP(MAP_FOOTHILL_TOWN), MAP_NUM(MAP_FOOTHILL_TOWN), HEAL_LOCATION_FOOTHILL_TOWN},
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_FOOTHILL_TOWN:
        return FlagGet(FLAG_VISITED_FOOTHILL_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_FOOTHILL_TOWN,
        .flag = FLAG_VISITED_FOOTHILL_TOWN,
    },
    {
