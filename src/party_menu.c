...
void ItemUseCB_RareCandy(u8 taskId, TaskFunc task)
{
    ...
    if (cannotUseEffect)
    {
        ...
        if (targetSpecies != SPECIES_NONE)
        {
            ...
            // Item de importância não se gasta: é assim que TM reutilizável já
            // funciona (Task_LearnedMove, mais acima neste arquivo), e é o que
            // torna o ITEM_INFINITE_CANDY infinito sem caso especial por id.
