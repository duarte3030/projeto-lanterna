...
static const struct FrontierBrainMon sFrontierBrainsMons[][2][FRONTIER_PARTY_SIZE] =
{
    [FRONTIER_FACILITY_TOWER] =
    {
        // Silver Symbol.
        {
            ...
            },
            {
                ...
                .evs = {252, 0, 6, 0, 0, 252},
                .moves = {MOVE_BODY_SLAM, MOVE_CURSE, MOVE_REST, MOVE_CRUNCH},
            },
        },
        // Gold Symbol.
        {
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_METEOR_MASH, MOVE_BULLET_PUNCH, MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT},
            },
            {
                ...
                .nature = NATURE_TIMID,
                .evs = {6, 0, 0, 252, 252, 0},
                .moves = {MOVE_THUNDERBOLT, MOVE_CALM_MIND, MOVE_AURA_SPHERE, MOVE_EXTRASENSORY},
            },
            {
                ...
                .nature = NATURE_TIMID,
                .evs = {6, 0, 0, 252, 252, 0},
                .moves = {MOVE_PSYCHIC, MOVE_DRACO_METEOR, MOVE_CALM_MIND, MOVE_RECOVER},
            },
        },
    },
    [FRONTIER_FACILITY_DOME] =
    {
        ...
        {
            {
                ...
                .nature = NATURE_BRAVE,
                .evs = {252, 252, 6, 0, 0, 0},
                .moves = {MOVE_EARTHQUAKE, MOVE_WATERFALL, MOVE_ICE_PUNCH, MOVE_STEALTH_ROCK},
            },
            {
        ...
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {252, 252, 6, 0, 0, 0},
                .moves = {MOVE_METEOR_MASH, MOVE_EARTHQUAKE, MOVE_AGILITY, MOVE_EXPLOSION},
            },
            {
        ...
        {
            {
                ...
                .nature = NATURE_JOLLY,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_BRAVE_BIRD, MOVE_CROSS_POISON, MOVE_CONFUSE_RAY, MOVE_TOXIC},
            },
            {
            ...
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_SHADOW_CLAW, MOVE_HAMMER_ARM},
            },
        },
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {252, 252, 6, 0, 0, 0},
                .moves = {MOVE_GIGA_IMPACT, MOVE_EARTHQUAKE, MOVE_NIGHT_SLASH, MOVE_HAMMER_ARM},
            },
            {
                ...
                .nature = NATURE_BOLD,
                .evs = {252, 0, 252, 0, 6, 0},
                .moves = {MOVE_SURF, MOVE_CALM_MIND, MOVE_ICE_BEAM, MOVE_REST},
            },
        },
    },
    [FRONTIER_FACILITY_ARENA] =
    {
        // Silver Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_CALM,
                .evs = {252, 0, 6, 0, 0, 252},
                .moves = {MOVE_FOUL_PLAY, MOVE_CONFUSE_RAY, MOVE_TOXIC, MOVE_MOONLIGHT},
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_SHADOW_SNEAK, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE, MOVE_PROTECT},
            },
        },
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_JOLLY,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_SPORE, MOVE_MACH_PUNCH, MOVE_SEED_BOMB, MOVE_SWORDS_DANCE},
            },
            {
    ...
    [FRONTIER_FACILITY_FACTORY] =
    {
        // O time da fabrica e o UNICO que nao vai para a batalha: quando o
        // adversario e o Noland, DoFacilityTrainerBattleInternal cai em
        // FACILITY_BATTLE_FACTORY e chama FillFactoryTrainerParty, que leva a
        // FillFactoryBrainParty (src/battle_factory.c:654) e sorteia tres
        // alugados do pote da instalacao. Estas duas linhas so aparecem no
        // cartao de adversario da CUPULA, entao os dois simbolos ficam iguais,
        // como na fonte, e sobem so de nivel de especie.
        // Silver Symbol.
        {
            {
                .species = SPECIES_METAGROSS,
            ...
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {252, 252, 6, 0, 0, 0},
                .moves = {MOVE_HEAD_SMASH, MOVE_IRON_HEAD, MOVE_EARTHQUAKE, MOVE_AVALANCHE},
            },
        },
        // Gold Symbol.
        {
        ...
        {
            {
                ...
                .nature = NATURE_BRAVE,
                .evs = {252, 252, 6, 0, 0, 0},
                .moves = {MOVE_POISON_JAB, MOVE_CRUNCH, MOVE_GIGA_DRAIN, MOVE_SWAGGER},
            },
            {
                ...
                .nature = NATURE_BOLD,
                .evs = {252, 0, 252, 0, 0, 6},
                .moves = {MOVE_TOXIC, MOVE_STEALTH_ROCK, MOVE_PROTECT, MOVE_REST},
            },
            {
        ...
        {
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_POISON_JAB, MOVE_CRUNCH, MOVE_SWAGGER, MOVE_GIGA_DRAIN},
            },
            {
                ...
                .nature = NATURE_TIMID,
                .evs = {6, 0, 0, 252, 252, 0},
                .moves = {MOVE_SLUDGE_WAVE, MOVE_DRAGON_PULSE, MOVE_NASTY_PLOT, MOVE_FLAMETHROWER},
            },
            {
    ...
    [FRONTIER_FACILITY_PYRAMID] =
    {
        // Silver Symbol.
        {
            ...
            },
            {
                ...
                .nature = NATURE_CAREFUL,
                .evs = {252, 0, 6, 0, 0, 252},
                .moves = {MOVE_IRON_HEAD, MOVE_CURSE, MOVE_TOXIC, MOVE_PROTECT},
            },
            {
        ...
        {
            {
                ...
                .nature = NATURE_TIMID,
                .evs = {6, 0, 0, 252, 252, 0},
                .moves = {MOVE_THUNDERBOLT, MOVE_VOLT_SWITCH, MOVE_THUNDER_WAVE, MOVE_EXPLOSION},
            },
            {
                ...
                .nature = NATURE_ADAMANT,
                .evs = {6, 252, 0, 252, 0, 0},
                .moves = {MOVE_OUTRAGE, MOVE_DRAGON_CLAW, MOVE_CRUNCH, MOVE_FIRE_FANG},
            },
            {
