...
## 9. Sandgem aplicada (11/09/2026, executor SANDGEM da onda 4)
...
### 9.1 Por que a regra 3.2 não serve para Sandgem
...
### 9.3 A ANIMAÇÃO: 4 antes, 0 no hack, 0 depois
...
### 9.4 TELHADO SÓLIDO (resposta 98): 46 células, e a régua mecânica não bastava
...
### 9.5 As saídas por warp, e a flag que a Route 201 exigiu
